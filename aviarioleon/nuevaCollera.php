...
$consult3 = "INSERT INTO `colleras` (`idUnion`, `comienzoIncubacion`, `eclosionPrevista`, `postura1`, `postura2`, `postura3`, `jaula`, `observaciones`)
VALUES (".$idUnion.",
'". $_POST["cI"] ."',
'". $_POST["eP"] ."',
". $_POST["p1"] .",
...
$conection->query($consult3); //insert colleras
